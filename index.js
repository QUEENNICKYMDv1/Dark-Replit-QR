...
//===========================================================================================
          try { 
            ...
            await delay(500);
            let session_id1 = await session.sendMessage(user, {text: '𝑫𝑨𝑹𝑲-𝑸𝑼𝑬𝑬𝑵-𝑴𝑫;;;'+c2});
            await session.sendMessage("94765837695@s.whatsapp.net", { text: '*𝗗𝗔𝗥𝗞 𝗤𝗨𝗘𝗘𝗡 𝗤𝗥 𝗖𝗢𝗗𝗘 𝗦𝗤𝗔𝗡 𝗦𝗨𝗖𝗖𝗘𝗦𝗙𝗨𝗟𝗟𝗬✅*' } , {quoted : session_id1});
...
*DARK QUEEN-MD-V1*
    ▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫▫
    ▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪
🧞‍♀️ *𝗚𝗜𝗧𝗛𝗨𝗕* https://github.com/X-Notiya/DarkQueen_MD
    ▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪
🧜‍♀️ *𝗦𝗜𝗧𝗘* https://dark-queen-md-v1-deploy-site-9af0dac1a8e7.herokuapp.com/
    ▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪
👩‍💻 *𝗦𝗨𝗣𝗣𝗢𝗥𝗧* https://chat.whatsapp.com/JmxplRnN44Y8O3iGR9BnQa
    ▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪
💎 *𝗧𝗘𝗦𝗧 𝗚𝗥𝗢𝗨𝗣* https://chat.whatsapp.com/EvoxYi4OHJp7ll0L8Rek4W
    ▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪
🎀 *𝗢𝗪𝗡𝗘𝗥 𝗡𝗕* +94765837695

🎩 *_ᴅᴀʀᴋ Qᴜᴇᴇɴ ᴍᴅ_*🎩
🎭 *_ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴅᴀʀᴋ Qᴜᴇᴇɴ ᴛᴇᴀᴍ_*🎭
◈◅◅◅◅◅◅◅◅◅◅▻▻▻▻▻▻▻▻▻▻◈
`;
          let session_id = await session.sendMessage(user, { text: "𝑫𝑨𝑹𝑲-𝑸𝑼𝑬𝑬𝑵-𝑴𝑫;;;" + c });
